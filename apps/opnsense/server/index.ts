// ========================================================================
// OPNsense App — Server Entry Module
//
// Registers OPNsense-specific API routes as a Fastify plugin, prefixed with
// /api/apps/opnsense/ and protected by app-level auth + permission
...
export default async function registerRoutes(fastify: FastifyInstance, ctx: AppRouteContext) {
  ...
  fastify.get('/meta', {
    preHandler: [hasPermission('firewall-aliases', 'read')],
