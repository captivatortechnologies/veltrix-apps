...
/**
 * Shows what this app manages on an OPNsense firewall, using the platform
...
export default function OverviewPage() {
  ...
  useEffect(() => {
    authFetch('/api/apps/opnsense/meta')
  ...
  if (loading) return <Spinner label="Loading OPNsense app details…" />
  if (error) {
