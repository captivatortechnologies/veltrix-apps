...
// This v0.1.0 foundation exposes read-only /meta + /settings routes that back the
// Overview page. BYOL hosting (provision a Keycloak stack) is planned for a later
// wave — see README.
// ========================================================================
