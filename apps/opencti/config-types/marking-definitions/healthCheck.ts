...
/**
 * Health for marking-definitions config = OpenCTI answers on its GraphQL API with
 ...
 * token authenticates. Verify the probe queries against a live OpenCTI instance.
 */
