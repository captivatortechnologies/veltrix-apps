...
/**
 * Shows what this app manages in a PagerDuty account, using the platform
...
export default function OverviewPage() {
  ...
  useEffect(() => {
    authFetch('/api/apps/pagerduty/meta')
  ...
  if (loading) return <Spinner label="Loading PagerDuty app details…" />
  ...
  return (
    <Card>
      <CardBody>
        <p>
          Manages PagerDuty incident-response configuration as code through the PagerDuty REST API v2.
          ...
          type. Auth is a REST API key; the base URL is fixed at <code>https://api.pagerduty.com</code>.
        </p>
