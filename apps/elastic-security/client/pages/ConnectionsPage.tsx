...
const APP_NAME = 'Elastic Security'
// Manifest id — used to reach this app's connectivity-test route.
const APP_ID = 'elastic-security'
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <Input
            ...
            placeholder="e.g. https://<deployment>.kb.<region>.cloud.es.io:9243"
            helperText="Kibana base URL / endpoint this connection reaches."
            fullWidth
            spellCheck={false}
            autoComplete="off"
          />
