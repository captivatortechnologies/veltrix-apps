// healthCheck for log-source-groups — the shared contract.
//
...
registerHealthCheckContract({
  ...
  handler: healthCheck,
  probePath: '/config/event_sources/log_source_management/log_source_groups',
  checkName: 'qradar-log-source-groups',
})
