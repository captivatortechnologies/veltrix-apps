// healthCheck for log-source-types — the shared contract.
//
...
registerHealthCheckContract({
  ...
  handler: healthCheck,
  probePath: '/config/event_sources/log_source_management/log_source_types',
  checkName: 'qradar-log-source-types',
})
