// healthCheck for resource-restrictions — the shared contract.
//
...
registerHealthCheckContract({
  label: 'resource-restrictions',
  handler: healthCheck,
  probePath: '/config/resource_restrictions',
  checkName: 'qradar-resource-restrictions',
})
