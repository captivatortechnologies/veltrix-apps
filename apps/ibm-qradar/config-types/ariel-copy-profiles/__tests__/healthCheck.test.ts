// healthCheck for ariel-copy-profiles — the shared contract.
//
...
registerHealthCheckContract({
  label: 'ariel-copy-profiles',
  handler: healthCheck,
  probePath: '/disaster_recovery/ariel_copy_profiles',
  checkName: 'qradar-ariel-copy-profiles',
})
