// healthCheck for offense-closing-reasons — the shared contract.
//
...
registerHealthCheckContract({
  label: 'offense-closing-reasons',
  handler: healthCheck,
  probePath: '/siem/offense_closing_reasons',
  checkName: 'qradar-offense-closing-reasons',
})
