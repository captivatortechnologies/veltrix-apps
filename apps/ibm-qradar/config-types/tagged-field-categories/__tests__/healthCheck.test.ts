// healthCheck for tagged-field-categories — the shared contract.
//
...
registerHealthCheckContract({
  label: 'tagged-field-categories',
  handler: healthCheck,
  probePath: '/ariel/taggedfieldcategories',
  checkName: 'qradar-tagged-field-categories',
})
