...
export default {
  ...
  sidebarItems: [
    { path: '/apps/ibm-qradar/overview', label: 'Overview', icon: 'shield' },
    { path: '/apps/ibm-qradar/setup', label: 'Setup Guide', icon: 'book' },
    { path: '/apps/ibm-qradar/connections', label: 'Connections', icon: 'link' },
  ],
}
