...
/**
 * Shows what this app manages in IBM QRadar, using the platform design-system
...
export default function OverviewPage() {
  ...
  useEffect(() => {
    authFetch('/api/apps/ibm-qradar/meta')
  ...
  if (loading) return <Spinner label="Loading IBM QRadar app details…" />
  if (error) {
  ...
  return (
    <Card>
      <CardBody>
        <p>
          Manages IBM QRadar configuration as code through the QRadar REST API. Create a
          ...
          Reference sets are reconciled to exactly the declared values, and reconcile only ever
