// =============================================================================
// IBM QRadar — Server Entry Module
//
// Registers QRadar-specific API routes as a Fastify plugin, prefixed with
// /api/apps/ibm-qradar/ and protected by app-level auth + permission middleware.
// Read-only on the platform side: authoring happens in the Configuration Canvas,
// and every write to QRadar goes through the pipeline handlers (QRadar API).
// =============================================================================
...
export default async function registerRoutes(
  ...
  fastify.get('/meta', {
    preHandler: [hasPermission('reference-sets', 'read')],
  ...
  // The tenant's saved app settings (e.g. console_host, api_version).
