...
/**
 * What this app manages across GitHub repositories, rendered with the platform
...
export default function OverviewPage() {
  ...
  useEffect(() => {
    authFetch('/api/apps/github-advanced-security/meta')
  ...
  if (loading) return <Spinner label="Loading GitHub Advanced Security app details…" />
  ...
  return (
    <Card>
      <CardBody>
        <p>
          Manages GitHub Advanced Security posture as code. Author a per-repository configuration in the
          Configuration Canvas and deploy it through the pipeline — validate, deploy, health check, drift
          detection and rollback are handled per configuration type. Features (GitHub Advanced Security,
          secret scanning, push protection, Dependabot security updates and CodeQL default setup) are applied
