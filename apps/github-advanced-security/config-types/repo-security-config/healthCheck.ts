...
/**
 * Health for the repository-security config = GitHub answers on its REST API with
 * the configured token. Read-only: GET /user. Any response below 500 counts as
 * reachable (a 401/403 means the token is bad, surfaced as a failed check).
 */
