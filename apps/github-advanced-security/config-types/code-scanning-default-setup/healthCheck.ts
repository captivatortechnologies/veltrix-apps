...
/**
 * Health for the code-scanning default-setup config = GitHub answers on its
 * REST API with the configured token. Read-only: GET /user. A 401/403 means
 * the token is bad, surfaced as a failed check.
 */
