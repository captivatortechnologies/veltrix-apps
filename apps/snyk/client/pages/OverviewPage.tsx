...
/**
 * Shows what this app manages in a Snyk organization, using the platform
...
export default function OverviewPage() {
  ...
  if (loading) return <Spinner label="Loading Snyk app details…" />
  if (error) {
  ...
  return (
    <Card>
      <CardBody>
        <p>
          Manages Snyk organization configuration as code across the Snyk REST and v1 APIs. Create a
