// healthCheck for source-schemas — the shared ISC probe contract.
//
...
//
// Source schemas are nested under a source, so reachability is probed against the
// parent sources collection.
