...
/**
 * Shows what this app manages in a SailPoint Identity Security Cloud tenant,
 * using the platform design-system components from @veltrixsecops/app-sdk/ui —
 * so the page matches the platform look and picks up the app's brand color.
...
export default function OverviewPage() {
  ...
  useEffect(() => {
    authFetch('/api/apps/sailpoint/meta')
  ...
  if (loading) return <Spinner label="Loading SailPoint app details…" />
  if (error) {
  ...
  return (
    <Card>
      <CardBody>
        <p>
          Manages SailPoint Identity Security Cloud (ISC) configuration as code through the ISC API.
          ...
          configuration type. Deploys reconcile live objects against your declared configuration and
          only ever manage what this app created.
        </p>
