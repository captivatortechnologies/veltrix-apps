      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <Input
            ...
            placeholder="e.g. https://soar.example.com"
            helperText="The SOAR base URL this connection reaches (e.g. https://soar.example.com). The automation token goes in the API token field."
            fullWidth
            spellCheck={false}
            autoComplete="off"
          />
