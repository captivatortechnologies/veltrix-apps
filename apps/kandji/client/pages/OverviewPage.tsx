...
/**
 * Shows what this app manages in a Kandji tenant, using the platform
...
export default function OverviewPage() {
  ...
  useEffect(() => {
    authFetch('/api/apps/kandji/meta')
  ...
  if (loading) return <Spinner label="Loading Kandji app details..." />
  if (error) {
  ...
  return (
    <Card>
      <CardBody>
        <p>
          Manages Kandji (Apple device management / MDM) configuration as code through the Kandji tenant
