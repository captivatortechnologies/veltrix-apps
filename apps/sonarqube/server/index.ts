...
// Read-only on the platform side: quality-gate authoring happens in the
// Configuration Canvas, and every write goes through the pipeline handlers
// (SonarQube Web API). This foundation exposes /meta + /settings routes that back
// the Overview page. BYOL infrastructure hosting for a SonarQube server is planned
// for a later release.
// ========================================================================
