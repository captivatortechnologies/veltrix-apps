// healthCheck for entitlement-access-package-catalogs — the shared Entra probe contract, driven against a fake Graph.
//
...
registerHealthCheckContract({
  label: 'entitlement-access-package-catalogs',
  handler: healthCheck,
  checkName: 'graph-entitlement-catalogs',
