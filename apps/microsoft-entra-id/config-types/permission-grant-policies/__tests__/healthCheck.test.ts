// healthCheck for permission-grant-policies — the shared Entra probe contract, driven against a fake Graph.
//
...
registerHealthCheckContract({
  label: 'permission-grant-policies',
  handler: healthCheck,
  checkName: 'graph-permission-grant-policies',
