// healthCheck for custom-security-attribute-definitions — the shared Entra probe contract, driven against a fake Graph.
//
...
registerHealthCheckContract({
  label: 'custom-security-attribute-definitions',
  handler: healthCheck,
  checkName: 'graph-attribute-definitions',
