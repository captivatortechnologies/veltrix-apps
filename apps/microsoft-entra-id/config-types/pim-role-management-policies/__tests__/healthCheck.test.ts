// healthCheck for pim-role-management-policies — the shared Entra probe contract, driven against a fake Graph.
//
...
registerHealthCheckContract({
  label: 'pim-role-management-policies',
  handler: healthCheck,
  checkName: 'graph-role-management-policies',
