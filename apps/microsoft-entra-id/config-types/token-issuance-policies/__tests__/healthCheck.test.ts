// healthCheck for token-issuance-policies — the shared Entra probe contract, driven against a fake Graph.
//
...
registerHealthCheckContract({
  label: 'token-issuance-policies',
  handler: healthCheck,
  checkName: 'graph-token-issuance-policies',
