// healthCheck for identity-security-defaults — the shared Entra probe contract, driven against a fake Graph.
//
...
registerHealthCheckContract({
  label: 'identity-security-defaults',
  handler: healthCheck,
  checkName: 'graph-security-defaults',
