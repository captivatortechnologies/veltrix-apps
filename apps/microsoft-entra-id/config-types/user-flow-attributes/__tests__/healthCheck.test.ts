// healthCheck for user-flow-attributes — the shared Entra probe contract, driven against a fake Graph.
//
...
registerHealthCheckContract({
  label: 'user-flow-attributes',
  handler: healthCheck,
  checkName: 'graph-user-flow-attributes',
