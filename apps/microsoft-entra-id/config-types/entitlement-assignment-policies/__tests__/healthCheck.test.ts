// healthCheck for entitlement-assignment-policies — the shared Entra probe contract, driven against a fake Graph.
//
...
registerHealthCheckContract({
  label: 'entitlement-assignment-policies',
  handler: healthCheck,
  checkName: 'graph-assignment-policies',
