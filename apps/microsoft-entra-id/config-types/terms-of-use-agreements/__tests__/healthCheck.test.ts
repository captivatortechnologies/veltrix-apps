// healthCheck for terms-of-use-agreements — the shared Entra probe contract, driven against a fake Graph.
//
...
registerHealthCheckContract({
  label: 'terms-of-use-agreements',
  handler: healthCheck,
  checkName: 'graph-terms-of-use-agreements',
