// healthCheck for claims-mapping-policies — the shared Entra probe contract, driven against a fake Graph.
//
...
registerHealthCheckContract({
  label: 'claims-mapping-policies',
  handler: healthCheck,
  checkName: 'graph-claims-mapping-policies',
