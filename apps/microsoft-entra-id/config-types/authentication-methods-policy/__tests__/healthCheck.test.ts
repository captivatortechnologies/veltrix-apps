// healthCheck for authentication-methods-policy — the shared Entra probe contract, driven against a fake Graph.
//
...
registerHealthCheckContract({
  ...
  handler: healthCheck,
  checkName: 'graph-authentication-methods-policy',
