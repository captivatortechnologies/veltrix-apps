// healthCheck for activity-based-timeout-policies — the shared Entra probe contract, driven against a fake Graph.
//
...
registerHealthCheckContract({
  label: 'activity-based-timeout-policies',
  handler: healthCheck,
  checkName: 'graph-activity-based-timeout-policies',
