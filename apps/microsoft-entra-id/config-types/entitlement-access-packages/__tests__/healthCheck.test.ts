// healthCheck for entitlement-access-packages — the shared Entra probe contract, driven against a fake Graph.
//
...
registerHealthCheckContract({
  label: 'entitlement-access-packages',
  handler: healthCheck,
  checkName: 'graph-access-packages',
