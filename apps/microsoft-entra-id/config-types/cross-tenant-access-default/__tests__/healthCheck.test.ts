// healthCheck for cross-tenant-access-default — the shared Entra probe contract, driven against a fake Graph.
//
...
registerHealthCheckContract({
  label: 'cross-tenant-access-default',
  handler: healthCheck,
  checkName: 'graph-cross-tenant-access-default',
