...
const VALID_DEF = '{"HomeRealmDiscoveryPolicy":{"AccelerateToFederatedDomain":false}}'
...
describe('home-realm-discovery validate', () => {
  it('accepts a valid policy', () => {
    const r = validate(ctxWith([{ name: 'HRD', fields: { name: 'HRD', definition: VALID_DEF } }]))
