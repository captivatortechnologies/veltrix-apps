// healthCheck for custom-security-attribute-sets — the shared Entra probe contract, driven against a fake Graph.
//
...
registerHealthCheckContract({
  label: 'custom-security-attribute-sets',
  handler: healthCheck,
  checkName: 'graph-attribute-sets',
