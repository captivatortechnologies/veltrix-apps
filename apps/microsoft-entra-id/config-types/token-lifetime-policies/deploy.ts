...
/** tokenLifetimePolicy is assignable to service principals ONLY: "You can have
 *  multiple tokenLifetimePolicy policies in a tenant but can assign only one
 *  tokenLifetimePolicy per service principal."
