...
/**
 * Health for the calendar-integrations config type = the Fleet server answers
 * on its REST API with the configured credential. Read-only: GET /api/v1/
 * fleet/version. Any response below 500 counts as reachable (whether the
 * org-wide Google Calendar integration is configured surfaces at deploy time,
 * not here). Verify against a live Fleet (fleetdm) instance.
 */
