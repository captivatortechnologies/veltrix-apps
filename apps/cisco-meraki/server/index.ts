// ========================================================================
// Cisco Meraki App — Server Entry Module
//
// Registers Cisco Meraki-specific API routes as a Fastify plugin, prefixed
// with /api/apps/cisco-meraki/ and protected by app-level auth + permission
...
export default async function registerRoutes(fastify: FastifyInstance, ctx: AppRouteContext) {
  ...
  fastify.get('/meta', {
    preHandler: [hasPermission('l3-firewall-rules', 'read')],
