...
/**
 * Shows what this app manages in a PingOne environment, using the platform
...
export default function OverviewPage() {
  ...
  useEffect(() => {
    authFetch('/api/apps/ping-identity/meta')
  ...
  if (loading) return <Spinner label="Loading Ping Identity app details..." />
  if (error) {
  ...
  return (
    <Card>
      <CardBody>
        <p>
          Manages PingOne configuration as code through the PingOne Platform API. Create a
