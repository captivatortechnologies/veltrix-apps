...
/**
 * What this app manages in a Sumo Logic org, rendered with the platform
...
export default function OverviewPage() {
  ...
  useEffect(() => {
    authFetch('/api/apps/sumo-logic/meta')
  ...
  if (loading) return <Spinner label="Loading Sumo Logic app details…" />
  ...
  return (
    <Card>
      <CardBody>
        <p>
          Manages Sumo Logic (cloud SIEM &amp; log analytics) configuration as code. Author a configuration in
          the Configuration Canvas and deploy it through the pipeline — validate, deploy, health check, drift
          detection and rollback are handled per configuration type. Field Extraction Rules are applied over the
          Sumo Logic Management API (HTTPS) using an Access ID / Access Key.
        </p>
