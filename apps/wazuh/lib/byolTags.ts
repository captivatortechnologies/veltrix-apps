...
//
// Every Veltrix-provisioned object (the allocated subnet + every cluster
...
// platform packages the app against (the app pins ^3.6.0). The SDK keeps its own
 ...
 * cluster. Pure: the same input always yields the same ordered map.
 */
