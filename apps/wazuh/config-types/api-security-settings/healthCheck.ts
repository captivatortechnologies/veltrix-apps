...
/**
 * Health for API-security-settings config = the Wazuh manager API is reachable
 * and the configured credential authenticates. Authenticating (getToken)
 * already proves the credential; the follow-up GET /manager/status confirms
 * the manager daemons answer. Any response below 500 counts as reachable.
 */
