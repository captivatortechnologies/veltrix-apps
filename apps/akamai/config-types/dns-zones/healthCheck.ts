...
/**
 * Health for dns-zones config = the Edge DNS API answers to an EdgeGrid-signed
 * request. Read-only: GET /config-dns/v2/zones?showAll=false (page 1, minimal
 * page size) — a 2xx confirms the host resolves AND the EdgeGrid signature
 * authenticates for the Edge DNS product.
 */
