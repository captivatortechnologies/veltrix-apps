...
/**
 * Health for the activation config = the Akamai Network Lists API answers to an
 * EdgeGrid-signed request (the same seam activation uses to resolve list ids and
