...
/**
 * Health for cloudlets-policy-activation config = the Cloudlets API answers
 * to an EdgeGrid-signed request. Read-only: GET /cloudlets/v3/policies?size=10
 * — a 2xx confirms the host resolves AND the EdgeGrid signature authenticates
 * for the Cloudlets product.
 */
