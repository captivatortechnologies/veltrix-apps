...
**App:** `netskope` · **Category:** NETWORK · **Version:** 0.6.0  
...
<sub>Applies to: 22 config types · 4 API families.</sub>
...
sequenceDiagram
  ...
  participant api as Netskope API
  ...
  Note over rbac: configuration-canvasread · componentread · credentialread + url-listswrite
...
sequenceDiagram
  ...
  pipeline->>rbac: authorize actor (RBAC)
  Note over rbac: componentread + url-listsread
  rbac-->>pipeline: permitted ✓ / denied
