// getStatus for destination-profiles — the shared contract.
//
...
registerGetStatusContract({ label: 'destination-profiles', handler: getStatus, configTypeId: 'destination-profiles' })
