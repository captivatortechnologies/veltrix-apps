// getStatus for npa-publishers-alerts-configuration — the shared contract.
//
...
registerGetStatusContract({ label: 'npa-publishers-alerts-configuration', handler: getStatus, configTypeId: 'npa-publishers-alerts-configuration' })
