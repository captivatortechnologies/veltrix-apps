// getStatus for npa-local-broker-config — the shared contract.
//
...
registerGetStatusContract({ label: 'npa-local-broker-config', handler: getStatus, configTypeId: 'npa-local-broker-config' })
