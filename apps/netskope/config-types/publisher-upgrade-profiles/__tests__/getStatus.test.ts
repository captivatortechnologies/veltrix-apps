// getStatus for publisher-upgrade-profiles — the shared contract.
//
...
registerGetStatusContract({ label: 'publisher-upgrade-profiles', handler: getStatus, configTypeId: 'publisher-upgrade-profiles' })
