...
/**
 * Shows what this app manages in a OneLogin account, using the platform
...
export default function OverviewPage() {
  ...
  useEffect(() => {
    authFetch('/api/apps/onelogin/meta')
  ...
  if (loading) return <Spinner label="Loading OneLogin app details..." />
  if (error) {
  ...
  return (
    <Card>
      <CardBody>
        <p>
          Manages OneLogin configuration as code through the OneLogin API. Create a configuration in
