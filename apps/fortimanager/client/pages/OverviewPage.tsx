...
/**
 * Shows what this app manages in FortiManager, using the platform design-system
...
export default function OverviewPage() {
  ...
  useEffect(() => {
    authFetch('/api/apps/fortimanager/meta')
  ...
  if (loading) return <Spinner label="Loading FortiManager app details…" />
  if (error) {
  ...
  return (
    <Card>
      <CardBody>
        <p>
          Manages Fortinet FortiManager configuration as code through the FortiManager JSON-RPC API.
          ...
          configuration type. Objects are managed in the ADOM object database; when the ADOM is in
          workspace mode, deploys wrap their changes in a lock / commit / unlock transaction.
        </p>
