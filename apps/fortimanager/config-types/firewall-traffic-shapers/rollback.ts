...
import { trafficShaperUrl, type RollbackEntry } from './deploy'
...
export default async function rollback(ctx: RollbackContext): Promise<RollbackResult> {
  ...
  return { success: true, message: `Rolled back firewall traffic shapers: ${deleted} deleted, ${restored} restored` }
}
