...
import { proxyAddressUrl, type RollbackEntry } from './deploy'
...
export default async function rollback(ctx: RollbackContext): Promise<RollbackResult> {
  ...
  return { success: true, message: `Rolled back explicit-proxy addresses: ${deleted} deleted, ${restored} restored` }
}
