import validate, { splitMembers, liveMemberNames, extractAddressGroupSpecs } from '../validate'
...
describe('firewall-address-groups validate', () => {
  it('accepts a valid group', () => {
    const r = validate(ctxWith([{ name: 'Web', fields: { name: 'Web', members: 'DMZ\nAppTier' } }]))
...
describe('extractAddressGroupSpecs', () => {
  it('parses members', () => {
    const specs = extractAddressGroupSpecs({
