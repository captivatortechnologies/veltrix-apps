...
import { appControlUrl, type RollbackEntry } from './deploy'
...
export default async function rollback(ctx: RollbackContext): Promise<RollbackResult> {
  ...
  return { success: true, message: `Rolled back application control profiles: ${deleted} deleted, ${restored} restored` }
}
