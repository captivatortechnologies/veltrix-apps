...
import { serviceGroupUrl, type RollbackEntry } from './deploy'
...
export default async function rollback(ctx: RollbackContext): Promise<RollbackResult> {
  ...
  return { success: true, message: `Rolled back firewall service groups: ${deleted} deleted, ${restored} restored` }
}
