...
import { dnsfilterProfileUrl, type RollbackEntry } from './deploy'
...
export default async function rollback(ctx: RollbackContext): Promise<RollbackResult> {
  ...
  return { success: true, message: `Rolled back DNS filter profiles: ${deleted} deleted, ${restored} restored` }
}
