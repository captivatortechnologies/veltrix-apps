...
import { multicastAddressUrl, type RollbackEntry } from './deploy'
...
export default async function rollback(ctx: RollbackContext): Promise<RollbackResult> {
  ...
  return { success: true, message: `Rolled back firewall multicast addresses: ${deleted} deleted, ${restored} restored` }
}
