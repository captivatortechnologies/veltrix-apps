...
import { webfilterProfileUrl, type RollbackEntry } from './deploy'
...
export default async function rollback(ctx: RollbackContext): Promise<RollbackResult> {
  ...
  return { success: true, message: `Rolled back web filter profiles: ${deleted} deleted, ${restored} restored` }
}
