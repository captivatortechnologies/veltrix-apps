...
import { internetServiceCustomUrl, type RollbackEntry } from './deploy'
...
export default async function rollback(ctx: RollbackContext): Promise<RollbackResult> {
  ...
  return { success: true, message: `Rolled back custom internet services: ${deleted} deleted, ${restored} restored` }
}
