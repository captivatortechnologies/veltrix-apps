...
import { addrgrp6Url, type RollbackEntry } from './deploy'
...
export default async function rollback(ctx: RollbackContext): Promise<RollbackResult> {
  ...
  return { success: true, message: `Rolled back firewall IPv6 address groups: ${deleted} deleted, ${restored} restored` }
}
