...
import { scheduleGroupUrl, type RollbackEntry } from './deploy'
...
export default async function rollback(ctx: RollbackContext): Promise<RollbackResult> {
  ...
  return { success: true, message: `Rolled back firewall schedule groups: ${deleted} deleted, ${restored} restored` }
}
