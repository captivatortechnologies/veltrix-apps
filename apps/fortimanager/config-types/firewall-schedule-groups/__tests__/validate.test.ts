import validate, { splitMembers, liveMemberNames, extractScheduleGroupSpecs } from '../validate'
...
describe('firewall-schedule-groups validate', () => {
  it('accepts a valid group', () => {
    const r = validate(ctxWith([{ name: 'Business', fields: { name: 'Business', members: 'WorkHours\nMaintenance' } }]))
...
describe('extractScheduleGroupSpecs', () => {
  it('parses members', () => {
    const specs = extractScheduleGroupSpecs({
