// =============================================================================
// Fortinet FortiManager — Server Entry Module
//
// Registers FortiManager-specific API routes as a Fastify plugin, prefixed with
// /api/apps/fortimanager/ and protected by app-level auth + permission
// middleware. Read-only on the platform side: authoring happens in the
// Configuration Canvas, and every write to FortiManager goes through the
// pipeline handlers (JSON-RPC API).
// =============================================================================
...
export default async function registerRoutes(
  ...
  fastify.get('/meta', {
    preHandler: [hasPermission('firewall-addresses', 'read')],
  ...
  // The tenant's saved app settings (e.g. host, adom, workspace_mode).
