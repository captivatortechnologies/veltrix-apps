...
export default {
  ...
  sidebarItems: [
    { path: '/apps/google-secops/overview', label: 'Overview', icon: 'shield' },
    { path: '/apps/google-secops/setup', label: 'Setup Guide', icon: 'book' },
    { path: '/apps/google-secops/connections', label: 'Connections', icon: 'link' },
  ],
}
