// ========================================================================
// Cloudflare App — Server Entry Module
//
// Registers Cloudflare-specific API routes as a Fastify plugin, prefixed with
// /api/apps/cloudflare/ and protected by app-level auth + permission
...
export default async function registerRoutes(fastify: FastifyInstance, ctx: AppRouteContext) {
  ...
  fastify.get('/meta', {
    preHandler: [hasPermission('cloudflare-dns-records', 'read')],
