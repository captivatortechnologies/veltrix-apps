...
/**
 * Shows what this app manages in a Cortex XSOAR server, using the platform
...
export default function OverviewPage() {
  ...
  useEffect(() => {
    authFetch('/api/apps/cortex-xsoar/meta')
  ...
  if (loading) return <Spinner label="Loading Cortex XSOAR app details…" />
  if (error) {
  ...
  return (
    <Card>
      <CardBody>
        <p>
          Manages Cortex XSOAR content configuration as code through the XSOAR server REST API.
          ...
          configuration type. Reconciliation is keyed by name across lists, incident types and
          scheduled jobs.
        </p>
