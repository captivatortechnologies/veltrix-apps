// ========================================================================
// Cortex XSOAR App — Server Entry Module
//
// Registers Cortex XSOAR-specific API routes as a Fastify plugin, prefixed with
// /api/apps/cortex-xsoar/ and protected by app-level auth + permission
...
export default async function registerRoutes(fastify: FastifyInstance, ctx: AppRouteContext) {
  ...
  fastify.get('/meta', {
    preHandler: [hasPermission('xsoar-lists', 'read')],
