...
/**
 * Report the current deployment status of a Suppression Rule configuration.
 * Reads deployment and component records through the platform data API — no
 * Datadog API call is made here (that's healthCheck's job).
 */
