...
/**
 * Shows what this app manages in a Datadog organization, using the platform
...
export default function OverviewPage() {
  ...
  useEffect(() => {
    authFetch('/api/apps/datadog/meta')
  ...
  if (loading) return <Spinner label="Loading Datadog app details…" />
  if (error) {
  ...
  return (
    <Card>
      <CardBody>
        <p>
          Manages Datadog as code: Security Monitoring rules/suppressions/filters, Sensitive Data Scanner (DLP),
          Log Management (pipelines/archives/metrics/indexes), Monitors, SLOs and RBAC Roles. Create a
