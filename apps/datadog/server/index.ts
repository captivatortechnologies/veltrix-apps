// ========================================================================
// Datadog App — Server Entry Module
//
// Registers Datadog-specific API routes as a Fastify plugin, prefixed with
// /api/apps/datadog/ and protected by app-level auth + permission middleware.
// Rule authoring happens in the Configuration Canvas, and every write goes
// through the pipeline handlers (Datadog Security Monitoring Rules API). This
// foundation exposes read-only /meta + /settings routes that back the
// Overview page.
// ========================================================================
...
export default async function registerRoutes(fastify: FastifyInstance, ctx: AppRouteContext) {
  ...
  fastify.get('/meta', {
    preHandler: [hasPermission('security-monitoring-rules', 'read')],
