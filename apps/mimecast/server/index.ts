// =============================================================================
// Mimecast — Server Entry Module
//
// Registers Mimecast-specific API routes as a Fastify plugin, prefixed with
// /api/apps/mimecast/ and protected by app-level auth + permission middleware.
// Read-only on the platform side: authoring happens in the Configuration Canvas,
// and every write to Mimecast goes through the pipeline handlers (Mimecast API).
// =============================================================================
...
export default async function registerRoutes(
  ...
  fastify.get('/meta', {
    preHandler: [hasPermission('managed-urls', 'read')],
  ...
  // The tenant's saved app settings (e.g. base_url).
