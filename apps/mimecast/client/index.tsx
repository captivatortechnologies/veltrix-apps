...
export default {
  ...
  sidebarItems: [
    { path: '/apps/mimecast/overview', label: 'Overview', icon: 'shield' },
    { path: '/apps/mimecast/setup', label: 'Setup Guide', icon: 'book' },
    { path: '/apps/mimecast/connections', label: 'Connections', icon: 'link' },
  ],
}
