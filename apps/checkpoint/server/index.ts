// ========================================================================
// Check Point App — Server Entry Module
//
// Registers Check Point-specific API routes as a Fastify plugin, prefixed
// with /api/apps/checkpoint/ and protected by app-level auth + permission
...
// (the Check Point Management API).
// ========================================================================
...
export default async function registerRoutes(fastify: FastifyInstance, ctx: AppRouteContext) {
  ...
  fastify.get('/meta', {
    preHandler: [hasPermission('network-hosts', 'read')],
