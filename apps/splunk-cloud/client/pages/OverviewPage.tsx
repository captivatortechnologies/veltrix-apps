...
/**
 * Shows what this app manages on Splunk Cloud via the ACS API.
...
export default function OverviewPage() {
  ...
  if (loading) return <p>Loading Splunk Cloud app details…</p>
  ...
  return (
    <div>
      ...
      <p>
        Manages Splunk Cloud Platform configuration as code through the Admin Config Service
        (ACS) API. Create a configuration in the Configuration Canvas and deploy it through the
