...
// Application CONFIGURATION authoring happens in the Configuration Canvas and
// every config write goes through the pipeline handlers (authentik Core REST
// API). This foundation exposes read-only /meta + /settings routes that back
// the Overview page.
// ========================================================================
