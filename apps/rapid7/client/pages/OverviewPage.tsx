...
/**
 * Shows what this app manages in a Rapid7 InsightVM console, using the platform
...
export default function OverviewPage() {
  ...
  useEffect(() => {
    authFetch('/api/apps/rapid7/meta')
  ...
  if (loading) return <Spinner label="Loading Rapid7 InsightVM app details…" />
  if (error) {
  ...
  return (
    <Card>
      <CardBody>
        <p>
          Manages Rapid7 InsightVM configuration as code through the Security Console API (v3). Create
