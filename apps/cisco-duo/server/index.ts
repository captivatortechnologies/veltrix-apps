// =============================================================================
// Cisco Duo — Server Entry Module
//
// Registers Duo-specific API routes as a Fastify plugin, prefixed with
// /api/apps/cisco-duo/ and protected by app-level auth + permission middleware.
// Read-only on the platform side: authoring happens in the Configuration Canvas,
// and every write to Duo goes through the pipeline handlers (Duo Admin API).
// =============================================================================
...
export default async function registerRoutes(
  ...
  fastify.get('/meta', {
    preHandler: [hasPermission('groups', 'read')],
  ...
  // The tenant's saved app settings (e.g. api_host).
