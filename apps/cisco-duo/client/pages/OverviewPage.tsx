...
/**
 * Shows what this app manages in Cisco Duo, using the platform design-system
...
export default function OverviewPage() {
  ...
  useEffect(() => {
    authFetch('/api/apps/cisco-duo/meta')
  ...
  if (loading) return <Spinner label="Loading Cisco Duo app details…" />
  if (error) {
  ...
  return (
    <Card>
      <CardBody>
        <p>
          Manages Cisco Duo configuration as code through the Duo Admin API. Create a configuration in
          the Configuration Canvas and deploy it through the pipeline — validate, deploy, health
          check, drift detection, and rollback are all handled per configuration type. Deploys
          reconcile live objects against your declared configuration and only ever manage what this
          app created.
        </p>
