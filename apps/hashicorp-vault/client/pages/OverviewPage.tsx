...
/**
 * Shows what this app manages in a HashiCorp Vault cluster, using the platform
...
export default function OverviewPage() {
  ...
  useEffect(() => {
    authFetch('/api/apps/hashicorp-vault/meta')
  ...
  if (loading) return <Spinner label="Loading HashiCorp Vault app details…" />
  if (error) {
  ...
  return (
    <Card>
      <CardBody>
        <p>
          Manages HashiCorp Vault configuration as code through the Vault HTTP API. Create a
