      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <Input
            ...
            helperText="Vault base URL this connection reaches. The Vault token goes in the API token field below."
            fullWidth
            spellCheck={false}
            autoComplete="off"
          />
