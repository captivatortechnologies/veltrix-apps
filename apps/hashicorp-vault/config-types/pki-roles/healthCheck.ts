...
import { extractPkiRoleSpecs, roleKey } from './validate'

/**
 * Health check for PKI role configuration:
 ...
 *   3. Every declared role is still present under its mount
