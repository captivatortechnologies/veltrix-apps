...
/**
 * Shows what this app manages in Cisco Umbrella, using the platform
 * design-system components from @veltrixsecops/app-sdk/ui. Authoring/editing
...
export default function OverviewPage() {
  ...
  useEffect(() => {
    authFetch('/api/apps/cisco-umbrella/meta')
  ...
  if (loading) return <Spinner label="Loading Cisco Umbrella app details…" />
  ...
  return (
    <Card>
      <CardBody>
        <p>
          Manages Cisco Umbrella policy configuration as code through the Umbrella API. Create a
          ...
          Deploys reconcile live objects against your declared configuration and only ever manage what
          this app created.
        </p>
