...
/**
 * Health for the suspicious-objects config = Trend Vision One answers on its public
 * API with the configured API key. Read-only: GET /threatintel/suspiciousObjects
 * (top=1). A 2xx (or any response below 500) counts as reachable; 401/403 mean the
 * key is bad. VERIFY the probe endpoint against a live Vision One tenant.
 */
