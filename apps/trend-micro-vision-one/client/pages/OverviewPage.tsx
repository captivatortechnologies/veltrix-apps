...
/**
 * What this app manages in a Trend Vision One tenant, rendered with the platform
...
export default function OverviewPage() {
  ...
  useEffect(() => {
    authFetch('/api/apps/trend-micro-vision-one/meta')
  ...
  if (loading) return <Spinner label="Loading Trend Vision One app details…" />
  ...
  return (
    <Card>
      <CardBody>
        <p>
          Manages Trend Micro Vision One threat intelligence as code. Author a configuration in the
          Configuration Canvas and deploy it through the pipeline — validate, deploy, health check, drift
          detection and rollback are handled per configuration type. Suspicious objects are applied over the
          Trend Vision One public REST API (v3.0, Bearer token) at your regional API host.
        </p>
