...
const good = { name: 'List of known IPv4 public DNS resolvers', state: 'enabled', comment: 'reduce false positives' }
...
test('validate accepts a good warninglist for each state', async () => {
