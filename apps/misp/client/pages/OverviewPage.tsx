...
/**
 * What this app manages in a MISP instance, rendered with the platform
...
export default function OverviewPage() {
  ...
  if (loading) return <Spinner label="Loading MISP app details…" />
  ...
  return (
    <Card>
      <CardBody>
        <p>
          Manages MISP (open-source Threat Intelligence Platform) configuration as code. Author a
          configuration in the Configuration Canvas and deploy it through the pipeline — validate, deploy,
          health check, drift detection and rollback are handled per configuration type. Threat feeds are
          applied over the MISP REST API (HTTPS 443, self-signed tolerated).
        </p>
