...
/**
 * Shows what this app manages in a CyberArk PVWA, using the platform
...
export default function OverviewPage() {
  ...
  useEffect(() => {
    authFetch('/api/apps/cyberark/meta')
  ...
  if (loading) return <Spinner label="Loading CyberArk PAM app details…" />
  if (error) {
  ...
  return (
    <Card>
      <CardBody>
        <p>
          Manages CyberArk Privileged Access Manager configuration as code through the PVWA REST API.
