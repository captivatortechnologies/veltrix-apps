...
/**
 * Report the current deployment status of the product settings across the
 * workspace components this config type targets. Reads deployment + component
 * records through the platform data API.
 */
