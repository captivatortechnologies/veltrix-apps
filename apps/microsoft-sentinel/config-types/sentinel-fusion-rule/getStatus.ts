...
/**
 * Report the current deployment status of the Fusion rule across the workspace
 * components this config type targets. Reads deployment + component records
 * through the platform data API.
 */
