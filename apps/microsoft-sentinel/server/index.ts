// ========================================================================
// Microsoft Sentinel App — Server Entry Module
//
// Registers Sentinel-specific API routes as a Fastify plugin, prefixed with
// /api/apps/microsoft-sentinel/ and protected by app-level auth + permission
...
// (Azure Resource Manager / Microsoft.SecurityInsights).
// ========================================================================
...
export default async function registerRoutes(fastify: FastifyInstance, ctx: AppRouteContext) {
  ...
  fastify.get('/meta', {
    preHandler: [hasPermission('sentinel-analytics-rules', 'read')],
