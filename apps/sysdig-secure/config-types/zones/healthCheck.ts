...
/**
 * Health for the zones config = Sysdig Secure answers on its REST API with the
 * configured Bearer token. Read-only probe of the exact API surface this
 * config type writes to: GET /platform/v1/zones.
 */
