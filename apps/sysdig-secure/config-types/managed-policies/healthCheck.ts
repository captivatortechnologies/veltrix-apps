...
/**
 * Health for the managed-policies config = Sysdig Secure answers on its REST
 * API with the configured Bearer token. Read-only probe of the exact API
 * surface this config type writes to: GET /api/v2/policies.
 */
