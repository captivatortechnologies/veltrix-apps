...
/**
 * Health for the scanners config = gvmd accepts a GMP connection,
 ...
 * (XML over TLS, 9390). (verify_scanner — a live per-scanner connectivity
 * probe — is a runtime action, not wired to this health check; see the app
