...
/**
 * Health for index-template config = Elasticsearch is reachable with the
 * configured credential and the cluster is not red (a template PUT needs a
 * writable cluster). Read-only: GET ${esUrl}/_cluster/health.
 */
