// ========================================================================
// Teleport App - Server Entry Module
//
// Registers app-specific API routes as a Fastify plugin, prefixed with
// /api/apps/teleport/ and protected by app-level auth + permission
// middleware. Read-only on the platform side: authoring happens in the
// Configuration Canvas, and every write to Teleport goes through the pipeline
// handlers (the Teleport Proxy web API).
// ========================================================================
