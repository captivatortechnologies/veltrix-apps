// ========================================================================
// Microsoft Intune App — Server Entry Module
//
// Registers Intune-specific API routes as a Fastify plugin, prefixed with
// /api/apps/microsoft-intune/ and protected by app-level auth + permission
...
export default async function registerRoutes(fastify: FastifyInstance, ctx: AppRouteContext) {
  ...
  fastify.get('/meta', {
    preHandler: [hasPermission('intune-asr-rules', 'read')],
