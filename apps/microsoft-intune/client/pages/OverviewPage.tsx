...
/**
 * Shows what this app manages in a Microsoft Intune tenant, using the platform
...
export default function OverviewPage() {
  ...
  useEffect(() => {
    authFetch('/api/apps/microsoft-intune/meta')
  ...
  if (loading) return <Spinner label="Loading Microsoft Intune app details…" />
  if (error) {
  ...
  return (
    <Card>
      <CardBody>
        <p>
          Manages Microsoft Intune endpoint-security policies as code through the Microsoft Graph API.
          ...
          configuration type. These policies configure Microsoft Defender for Endpoint and can be
          delivered via Intune or Defender security settings management.
        </p>
