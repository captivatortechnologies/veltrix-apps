...
export interface InternetFirewallSectionSpec extends SectionSpec {
  itemId?: string
}

/** Extract one Internet Firewall section spec per canvas item. */
export function extractSectionSpecs(canvas: CanvasSnapshot): InternetFirewallSectionSpec[] {
...
/**
 * Validate Internet Firewall section items. Static only - no target access:
