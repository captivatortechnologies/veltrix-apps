...
export default {
  ...
  sidebarItems: [
    { path: '/apps/illumio/overview', label: 'Overview', icon: 'shield' },
    { path: '/apps/illumio/setup', label: 'Setup Guide', icon: 'book' },
    { path: '/apps/illumio/connections', label: 'Connections', icon: 'link' },
  ],
}
