...
/**
 * What this app manages in a Vectra brain, rendered with the platform
...
export default function OverviewPage() {
  ...
  useEffect(() => {
    authFetch('/api/apps/vectra-ai/meta')
  ...
  if (loading) return <Spinner label="Loading Vectra AI app details…" />
  ...
  return (
    <Card>
      <CardBody>
        <p>
          Manages Vectra AI (Network Detection &amp; Response) configuration as code. Author a configuration
          in the Configuration Canvas and deploy it through the pipeline — validate, deploy, health check,
          drift detection and rollback are handled per configuration type. Triage rules are applied over the
          Vectra Detect REST API (v2.5, HTTPS 443).
        </p>
