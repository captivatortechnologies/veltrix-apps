// ========================================================================
// Automox App — Server Entry Module
//
// Registers Automox-specific API routes as a Fastify plugin, prefixed with
// /api/apps/automox/ and protected by app-level auth + permission middleware.
// Read-only on the platform side: authoring happens in the Configuration
// Canvas, and every write to Automox goes through the pipeline handlers
// (Automox Console API). These routes back the Overview page.
// ========================================================================
