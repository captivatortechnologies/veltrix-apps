...
/**
 * What this app manages in Automox, rendered with the platform design-system
...
export default function OverviewPage() {
  ...
  useEffect(() => {
    authFetch('/api/apps/automox/meta')
  ...
  if (loading) return <Spinner label="Loading Automox app details…" />
  ...
  return (
    <Card>
      <CardBody>
        <p>
          Manages Automox endpoint patch management configuration as code. Author a configuration in
          the Configuration Canvas and deploy it through the pipeline — validate, deploy, health check,
          drift detection and rollback are handled per configuration type. Changes are applied over the
          Automox Console REST API using a Bearer API key, scoped to an Organization ID.
        </p>
