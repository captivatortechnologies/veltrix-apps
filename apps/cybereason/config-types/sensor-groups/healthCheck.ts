...
import { GROUP_ENDPOINTS } from './_shared'

/**
 * Health for sensor groups = Cybereason accepts the session-cookie login and
 * answers an authenticated read of GET /rest/groups (this type's list endpoint).
 */
