...
import { POLICY_ENDPOINTS } from './_shared'

/**
 * Health for sensor policies = Cybereason accepts the session-cookie login and
 * answers an authenticated read of GET /rest/policies (this type's list endpoint).
 */
