...
/**
 * What this app manages in JumpCloud, rendered with the platform design-system
...
export default function OverviewPage() {
  ...
  useEffect(() => {
    authFetch('/api/apps/jumpcloud/meta')
  ...
  if (loading) return <Spinner label="Loading JumpCloud app details…" />
  ...
  return (
    <Card>
      <CardBody>
        <p>
          Manages JumpCloud directory configuration as code. Author a configuration in the
          ...
          JumpCloud REST API (v2) using an <code>x-api-key</code> header.
        </p>
