...
/**
 * Shows what this app manages in Qualys, using the platform design-system
...
export default function OverviewPage() {
  ...
  useEffect(() => {
    authFetch('/api/apps/qualys/meta')
  ...
  if (loading) return <Spinner label="Loading Qualys app details…" />
  if (error) {
  ...
  return (
    <Card>
      <CardBody>
        <p>
          Manages Qualys VMDR / Policy Compliance configuration as code through the classic v2 API.
