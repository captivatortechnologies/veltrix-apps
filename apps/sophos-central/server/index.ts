// ========================================================================
// Sophos Central App — Server Entry Module
//
// Registers Sophos Central-specific API routes as a Fastify plugin, prefixed
// with /api/apps/sophos-central/ and protected by app-level auth + permission
...
export default async function registerRoutes(fastify: FastifyInstance, ctx: AppRouteContext) {
  ...
  fastify.get('/meta', {
    preHandler: [hasPermission('endpoint-policies', 'read')],
