...
/**
 * What this app manages in a Cribl deployment, rendered with the platform
...
export default function OverviewPage() {
  ...
  if (loading) return <Spinner label="Loading Cribl app details…" />
  ...
  return (
    <Card>
      <CardBody>
        <p>
          Manages Cribl Stream (telemetry / observability data pipeline) configuration as code. Author a
          configuration in the Configuration Canvas and deploy it through the pipeline — validate, deploy,
          health check, drift detection and rollback are handled per configuration type. Pipelines are applied
          over the Cribl REST API (worker-group aware, self-signed TLS tolerated).
        </p>
