...
import { canvasItems, normalizeName, readBool, strList } from '../../lib/canvas'

// Re-exported so existing project handlers + tests keep importing them from here.
export { canvasItems, normalizeName, readBool, strList }
