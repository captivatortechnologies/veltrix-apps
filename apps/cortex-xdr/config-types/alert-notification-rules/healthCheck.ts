...
/**
 * Health for alert-notification-rules config = Cortex XDR answers on its public
 * API with the configured API Key. Read-only: POST /endpoints/get_endpoint_groups/
