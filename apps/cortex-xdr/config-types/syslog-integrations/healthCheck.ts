...
/**
 * Health for syslog integrations config = Cortex XDR answers on its public API
 ...
 * 401/403 mean the key is bad. This intentionally does NOT call
 * /integrations/syslog/test/ per configured server — that endpoint fires a real
 * test message at the destination, which is not an appropriate side effect of a
 * routine health check (see the README).
 */
