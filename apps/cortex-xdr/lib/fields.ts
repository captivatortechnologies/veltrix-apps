// =============================================================================
// Shared canvas-field readers for the Cortex XDR config types.
//
...
// every handler (and into the app tests, which run them directly). Ported from
// apps/auth0/lib/fields.ts — the same contract, reused rather than re-invented.
// =============================================================================
...
/** Read a boolean field, tolerating the "true"/"false" string form the canvas may emit. */
...
/** Trim + lowercase a value for case-insensitive identity matching (names, hashes, ids). */
