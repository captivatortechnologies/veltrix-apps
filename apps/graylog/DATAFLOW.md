...
**App:** `graylog` · **Category:** SIEM · **Version:** 0.2.0  
...
sequenceDiagram
  ...
  Note over rbac: configuration-canvasread · configuration-canvaswrite · componentread · credentialread + streamswrite
...
sequenceDiagram
  ...
  pipeline->>rbac: authorize actor (RBAC)
  Note over rbac: componentread + streamsread
  rbac-->>pipeline: permitted ✓ / denied
