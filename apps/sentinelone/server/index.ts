// ========================================================================
// SentinelOne App — Server Entry Module
//
// Registers SentinelOne-specific API routes as a Fastify plugin, prefixed with
// /api/apps/sentinelone/ and protected by app-level auth + permission
...
export default async function registerRoutes(fastify: FastifyInstance, ctx: AppRouteContext) {
  ...
  fastify.get('/meta', {
    preHandler: [hasPermission('s1-exclusions', 'read')],
