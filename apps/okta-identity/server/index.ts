// ========================================================================
// Okta App — Server Entry Module
//
// Registers Okta-specific API routes as a Fastify plugin, prefixed with
// /api/apps/okta-identity/ and protected by app-level auth + permission
// middleware. Read-only on the platform side: authoring happens in the
// Configuration Canvas, and every write to Okta goes through the pipeline
// handlers (Okta Management API).
// ========================================================================
