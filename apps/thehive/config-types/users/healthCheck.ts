...
/**
 * Health for users config = TheHive answers on its REST API with the configured
 * API key. Read-only: GET /api/v1/user/current. A 2xx confirms the endpoint
 * resolves AND the key authenticates; any response below 500 counts as
 * reachable. Verify against a live TheHive (see README, v4 vs v5).
 */
