// ========================================================================
// CrowdStrike Falcon App - Server Entry Module
//
// Registers CrowdStrike-specific API routes as a Fastify plugin.
// These routes are prefixed with /api/apps/crowdstrike-edr/
...
// authoring happens in the Configuration Canvas, and all writes to the
// Falcon tenant go through the pipeline handlers (Falcon APIs).
// ========================================================================
...
export default async function registerRoutes(
  ...
  fastify.get('/meta', {
    preHandler: [hasPermission('host-groups', 'read')],
