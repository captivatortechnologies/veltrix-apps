...
/**
 * What this app manages in a ServiceNow instance, rendered with the platform
...
export default function OverviewPage() {
  ...
  useEffect(() => {
    authFetch('/api/apps/servicenow/meta')
  ...
  if (loading) return <Spinner label="Loading ServiceNow app details…" />
  ...
  return (
    <Card>
      <CardBody>
        <p>
          Manages ServiceNow configuration as code over the Table API (HTTPS, HTTP Basic auth). Author a
        ...
        <p>
          v0.1.0 manages <strong>business rules</strong> (the <code>sys_script</code> table): server-side
          scripts that run before/after/async or on query for a given table. ServiceNow is a large platform;
          this is a focused, security-relevant starting surface with more configuration types to follow.
        </p>
