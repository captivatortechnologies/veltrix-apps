...
/**
 * Shows what this app manages in a Tenable Vulnerability Management tenant,
...
export default function OverviewPage() {
  ...
  useEffect(() => {
    authFetch('/api/apps/tenable-vm/meta')
  ...
  if (loading) return <Spinner label="Loading Tenable VM app details…" />
  if (error) {
  ...
  return (
    <Card>
      <CardBody>
        <p>
          Manages Tenable Vulnerability Management configuration as code through the Tenable VM
