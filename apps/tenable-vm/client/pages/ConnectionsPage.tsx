...
const APP_NAME = 'Tenable Vulnerability Management'
// Manifest id — used to reach this app's connectivity-test route.
const APP_ID = 'tenable-vm'
...
export default function ConnectionsPage() {
  ...
  const usernameLabel = form.authType === 'token' ? 'Access key' : 'Username'
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <Input
            ...
            helperText="Tenable API base URL this connection reaches. Defaults to https://cloud.tenable.com; override only for a dedicated/FedRAMP host."
            fullWidth
            spellCheck={false}
            autoComplete="off"
          />
