...
/**
 * What this app manages in a Velociraptor server, rendered with the platform
...
export default function OverviewPage() {
  ...
  useEffect(() => {
    authFetch('/api/apps/velociraptor/meta')
  ...
  if (loading) return <Spinner label="Loading Velociraptor app details…" />
  ...
  return (
    <Card>
      <CardBody>
        <p>
          Manages Velociraptor (open-source endpoint DFIR / hunting platform) configuration as code. Author a
          configuration in the Configuration Canvas and deploy it through the pipeline — validate, deploy, health
          check, drift detection and rollback are handled per configuration type. Custom VQL artifacts are applied
          over the Velociraptor gRPC API (mutual TLS) by executing VQL.
        </p>
