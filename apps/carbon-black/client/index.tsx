...
export default {
  ...
  sidebarItems: [
    { path: '/apps/carbon-black/overview', label: 'Overview', icon: 'shield' },
    { path: '/apps/carbon-black/setup', label: 'Setup Guide', icon: 'book' },
    { path: '/apps/carbon-black/connections', label: 'Connections', icon: 'link' },
  ],
}
