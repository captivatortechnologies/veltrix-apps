...
/**
 * Shows what this app manages in VMware Carbon Black Cloud, using the platform
...
export default function OverviewPage() {
  ...
  useEffect(() => {
    authFetch('/api/apps/carbon-black/meta')
  ...
  if (loading) return <Spinner label="Loading Carbon Black app details…" />
  if (error) {
  ...
  return (
    <Card>
      <CardBody>
        <p>
          Manages VMware Carbon Black Cloud configuration as code through the CBC API. Create a
          ...
          Reputation overrides have no update API, so a change is applied as delete + recreate, and
          reconcile only ever manages what this app created.
        </p>
