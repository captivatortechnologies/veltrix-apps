...
/**
 * Shows what this app manages in Prisma Cloud, using the platform design-system
...
export default function OverviewPage() {
  ...
  useEffect(() => {
    authFetch('/api/apps/prisma-cloud/meta')
  ...
  if (loading) return <Spinner label="Loading Prisma Cloud app details…" />
  if (error) {
  ...
  return (
    <Card>
      <CardBody>
        <p>
          Manages Palo Alto Prisma Cloud (CSPM) configuration as code through the Prisma Cloud REST
          ...
          configuration type. Built-in (system default) standards are protected, and reconcile only
          ever manages what this app created.
        </p>
