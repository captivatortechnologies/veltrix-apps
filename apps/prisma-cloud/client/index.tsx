...
export default {
  ...
  sidebarItems: [
    { path: '/apps/prisma-cloud/overview', label: 'Overview', icon: 'shield' },
    { path: '/apps/prisma-cloud/setup', label: 'Setup Guide', icon: 'book' },
    { path: '/apps/prisma-cloud/connections', label: 'Connections', icon: 'link' },
  ],
}
