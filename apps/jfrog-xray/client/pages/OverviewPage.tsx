...
/**
 * Shows what this app manages in a JFrog Platform tenant, using the platform
...
export default function OverviewPage() {
  ...
  useEffect(() => {
    authFetch('/api/apps/jfrog-xray/meta')
  ...
  if (loading) return <Spinner label="Loading JFrog Xray app details…" />
  if (error) {
