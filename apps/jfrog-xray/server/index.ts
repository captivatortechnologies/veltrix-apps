// ========================================================================
// JFrog Xray App — Server Entry Module
//
// Registers JFrog Xray-specific API routes as a Fastify plugin, prefixed
// with /api/apps/jfrog-xray/ and protected by app-level auth + permission
...
export default async function registerRoutes(fastify: FastifyInstance, ctx: AppRouteContext) {
  ...
  fastify.get('/meta', {
    preHandler: [hasPermission('security-policies', 'read')],
