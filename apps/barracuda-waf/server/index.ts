// ========================================================================
// Barracuda WAF-as-a-Service App — Server Entry Module
//
// Registers app-specific API routes as a Fastify plugin, prefixed with
// /api/apps/barracuda-waf/ and protected by app-level auth + permission
...
// (the Barracuda WAF-as-a-Service REST API).
// ========================================================================
...
export default async function registerRoutes(fastify: FastifyInstance, ctx: AppRouteContext) {
  ...
  fastify.get('/meta', {
    preHandler: [hasPermission('basic-security', 'read')],
