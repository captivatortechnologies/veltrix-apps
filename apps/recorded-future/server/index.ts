// ========================================================================
// Recorded Future App — Server Entry Module
//
// Registers Recorded Future-specific API routes as a Fastify plugin, prefixed
// with /api/apps/recorded-future/ and protected by app-level auth + permission
...
export default async function registerRoutes(fastify: FastifyInstance, ctx: AppRouteContext) {
  ...
  fastify.get('/meta', {
    preHandler: [hasPermission('watch-lists', 'read')],
