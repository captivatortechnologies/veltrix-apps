...
/**
 * Shows what this app manages in an F5 Distributed Cloud namespace, using the
...
export default function OverviewPage() {
  ...
  useEffect(() => {
    authFetch('/api/apps/f5-distributed-cloud/meta')
  ...
  if (loading) return <Spinner label="Loading F5 Distributed Cloud app details..." />
  if (error) {
  ...
  return (
    <Card>
      <CardBody>
        <p>
          Manages F5 Distributed Cloud (XC) configuration as code through the F5 XC public config API.
